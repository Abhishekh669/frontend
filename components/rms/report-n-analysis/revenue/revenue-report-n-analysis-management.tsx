...
import RevenueDashboard from "./revenue-report-n-analysis-default-report";
import ReportAndAnalysisCustomDateRangePage from "./revenue-report-n-analysis-custom-date-range";
import { Database, Calendar } from "lucide-react";

function RevenueReportAndAnalysisManagementPage() {
    ...
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "default" | "custom")} className="w-full">
        ...
        <TabsContent value="custom" className="mt-0">
          <ReportAndAnalysisCustomDateRangePage />
        </TabsContent>
      </Tabs>
    </div>
  );
...
export default RevenueReportAndAnalysisManagementPage;