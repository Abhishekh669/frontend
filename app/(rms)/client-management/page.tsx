import ClientsManagement from '@/components/rms/client-management/client-management-page'
...
async function page() {
  ...
  if(!hasPermission(user.role, "view:clients" )){
    return null;
  }
  return (
   <ClientsManagement  user={user}/>
  )
}
